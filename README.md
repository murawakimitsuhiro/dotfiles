...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/murawakimitsuhiro/dotfiles/master/install.sh`"
```
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/murawakimitsuhiro/dotfiles/master/install.sh`" -s ask
```
